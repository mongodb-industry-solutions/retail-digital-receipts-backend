...
- **Perfect for mocks or external integrations**: In real-world systems, external metadata (like ERP or fraud scores) often comes from remote services. This function mimics that pattern.
